...
export function AuthCard({ title, subtitle, children, footer }: AuthCardProps) {
  return (
    <div className="min-h-dvh flex items-center justify-center px-6 py-10 relative">
      <BackgroundOrbs />
      <div className="w-full max-w-sm glass-strong rounded-3xl p-8 md:p-10 relative">
